        ...
        <section className="w-full lg:h-[755px] bg-cover bg-center bg-no-repeat flex flex-col justify-end pb-10 sm:pb-32 py-32 lg:pb-[110px]">
            <div className="container flex items-start justify-between flex-col-reverse lg:flex-row ">
                ...
                className="w-full lg:max-w-[530px]">
                    ...
                    <p className="font-mono text-light-purple " >Olá meu nome é </p>
                    <h2 className="text-4xl font-medium mt-2">Pedro Vitor</h2>
                    ...
                    <div className="mt-6 lg:mt-10 flex sm:items-center flex-col sm:gap-5 sm:flex-row">
                        ...
                        <div>
                            <Button className="w-max shadow-button" onClick={handleContact}>Entre em contato <HiArrowNarrowRight size={18}/></Button>
                        </div>
